...
# check.py
# This script checks the configuration for ID: V-13672
...
def check():
    """Checks if the directive Configure is set correctly."""
    ...
    match = re.search(r"^\s*Configure\s+(\d+)", content, re.MULTILINE)
