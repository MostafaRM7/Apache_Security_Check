...
# check.py
# This script checks the configuration for ID: V-2246
...
def check():
    """Checks if the directive Install is set correctly."""
    ...
    match = re.search(r"^\s*Install\s+(\d+)", content, re.MULTILINE)
