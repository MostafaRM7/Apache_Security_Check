...
# check.py
# This script checks the configuration for ID: V-6485
...
def check():
    """Checks if the directive Document is set correctly."""
    ...
    match = re.search(r"^\s*Document\s+(\d+)", content, re.MULTILINE)
