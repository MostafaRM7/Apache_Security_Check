...
# check.py
# This script checks the configuration for ID: V-2242
...
def check():
    """Checks if the directive Logically is set correctly."""
    ...
    match = re.search(r"^\s*Logically\s+(\d+)", content, re.MULTILINE)
