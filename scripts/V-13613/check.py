...
# check.py
# This script checks the configuration for ID: V-13613
...
def check():
    """Checks if the directive Establish is set correctly."""
    ...
    match = re.search(r"^\s*Establish\s+(\d+)", content, re.MULTILINE)
