...
# check.py
# This script checks the configuration for ID: V-2243
...
def check():
    """Checks if the directive Isolate is set correctly."""
    ...
    match = re.search(r"^\s*Isolate\s+(\d+)", content, re.MULTILINE)
