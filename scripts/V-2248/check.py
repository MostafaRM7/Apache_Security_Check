...
# check.py
# This script checks the configuration for ID: V-2248
...
def check():
    """Checks if the directive Restrict is set correctly."""
    ...
    match = re.search(r"^\s*Restrict\s+(\d+)", content, re.MULTILINE)
